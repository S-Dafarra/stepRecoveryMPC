...
/**
 * @file MPCIpOptSolverImplicit.h
 * @authors: Stefano Dafarra <stefano.dafarra@iit.it>
 */

#ifndef MPCIPOPTSOLVERIMPLICIT_H
#define MPCIPOPTSOLVERIMPLICIT_H
...
class MPCIpOptSolverImplicit : public Ipopt::TNLP {
    ...
    iDynTree::SparseMatrix m_costHessian;
    ...
    Eigen::SparseMatrix<double> m_EvGammaEigen, m_FGammaEigen;
    std::vector<Eigen::SparseMatrix<double>> m_iteratedModel;
    std::vector<Eigen::SparseMatrix<double>> m_controllabilityMatrix;
    std::vector<Eigen::SparseMatrix<double>> m_summedControllability;    
    std::vector<Eigen::VectorXd> m_biasImplicit;
    std::vector<Eigen::VectorXd> m_iteratedGamma0;
    std::vector<Eigen::VectorXd> m_gammaBuffer;
    Eigen::SparseMatrix<double> m_gammaWeightHessian, m_gammaWeightImpactHessian;
    iDynTree::SparseMatrix  m_wrenchWeightHessian, m_derivativeWrenchWeightHessian, m_negativeDerWrenchHessian;
    
    bool computeIteratedModelMatrices();
    bool updateGamma(const Eigen::VectorXd& solution);
    iDynTree::SparseMatrix convertSparse(Eigen::SparseMatrix<double>& input);
